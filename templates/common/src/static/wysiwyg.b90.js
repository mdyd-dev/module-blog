...
(function (navigator, window, document, $) {
  ...
  Trumbowyg.prototype = {
    ...
    buildBtn: function buildBtn(btnName) {// btnName is name of the button
      var t = this,
      prefix = t.o.prefix,
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;__webpack_require__(11);function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}

$.trumbowyg.svgPath = "".concat(__cdnUrl(), "images/trumbowyg-icons.svg");var

wysiwyg =
function wysiwyg() {_classCallCheck(this, wysiwyg);

...
var _vanillaLazyload = _interopRequireDefault(__webpack_require__(1));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

var wysiwygContent = document.querySelector('[data-wysiwyg="content"]');
if (wysiwygContent) {
  __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 2)).then(
  function (wysiwyg) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _typeof(obj) {if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {_typeof = function _typeof(obj) {return typeof obj;};} else {_typeof = function _typeof(obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;};}return _typeof(obj);}var SELECTOR_CLIENT = '[data-date="client"]';
var SELECTOR_SERVER = '[data-date="server"]';

var getClientValue = function getClientValue() {return document.querySelector(SELECTOR_CLIENT).value;};

var isDate = function isDate(date) {return _typeof(date) === 'object' && date.constructor === Date && date.toString() !== 'Invalid Date';};

var formatDate = function formatDate(date) {
  if (!isDate(date)) {
    throw new Error("String provided by user cannot be parsed into date :: '".concat(getClientValue(), "'"));
    return '';
  }
...
var formatValue = function formatValue(value) {
  ...
  console.info("Serving ".concat(formattedDate, " to the server from user input: ").concat(value));
};
...
var attachEventHandlers = function attachEventHandlers() {
  ...
  $(SELECTOR_CLIENT).on('blur', function (event) {return formatValue(event.target.value);});
};var

DateInterceptor =
function DateInterceptor() {_classCallCheck(this, DateInterceptor);
...
DateInterceptor;exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
